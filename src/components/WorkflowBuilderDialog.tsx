    ...
    <ScrollArea className="flex-1">
      <form onSubmit={handleSubmit} className="p-4 md:p-6">
                    ...
                    <div className="space-y-2">
                      ...
                      {step.fields?.map((field, fieldIndex) => (
                        <div key={field.id} className="border rounded p-3 space-y-2">
                          <div className="flex items-center justify-between">
                            <span className="text-xs text-muted-foreground">Field {fieldIndex + 1}</span>
                            <Button
                              type="button"
                              variant="ghost"
                              size="sm"
        ...
        <div className="flex gap-3 pt-6 sticky bottom-0 bg-background pb-4">
          ...
          <Button type="submit" disabled={workflowData.steps.length === 0} className="flex-1">
            Create Workflow
          </Button>
        </div>
      </form>
        ...
        <DrawerContent className="h-[95vh] max-h-[95vh] flex flex-col">
          <div className="flex items-center justify-between px-4 py-3 border-b border-border/40 shrink-0">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Multi-step workflow</p>
            </div>
            <button 
              onClick={onClose}
