            ...
            <div className="mt-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="p-6 flex items-center justify-between">
                  <span className="text-lg font-medium">Microsoft Office</span>
                  <Switch 
                ...
                <Card className="p-6 flex items-center justify-between">
                  <span className="text-lg font-medium">SharePoint</span>
                  <Switch 
                ...
                <Card className="p-6 flex items-center justify-between">
                  <span className="text-lg font-medium">Trello</span>
                  <Switch 
                ...
                <Card className="p-6 flex items-center justify-between">
                  <span className="text-lg font-medium">Asana</span>
                  <Switch 
                ...
                <Card className="p-6 flex items-center justify-between">
                  <span className="text-lg font-medium">Jira</span>
                  <Switch 
